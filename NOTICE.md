...
> Original source: the Open States API (Plural Policy).

## Two things the license does not cover

- **Upstream terms.** VoteGA's license covers the compilation, cleaning, and joins in this
  repository. The underlying facts come from the Open States API (Plural Policy), whose own terms may apply to
